...
//////////////////////////////////////////////
const char SSID_ESP[] = "IIIRPD AIRTEL";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "iiirpd@dhrala";             //Add the password of that WIFI connection
const char* host = "astylar-crop.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
